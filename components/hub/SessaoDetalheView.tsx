...
import type { ChatSessionRow, ChatMessageRow, IntegrationEventRow } from '@/lib/hubQueries';
...
interface SessaoDetalheViewProps {
  session: ChatSessionRow;
  messages: ChatMessageRow[];
  events: IntegrationEventRow[];
}

export default function SessaoDetalheView({ session, messages, events }: SessaoDetalheViewProps) {
  return (
    <div>
